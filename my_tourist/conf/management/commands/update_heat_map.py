...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        regions = {
            r["region"]: r["code"] for r in list(qs_regions.values("region", "code"))
        }
        ...
        with Command.get_browser() as browser:
            ...
            browser.find_element_by_id("b-domik_popup-username").send_keys(yandex_email)
            browser.find_element_by_id("b-domik_popup-password").send_keys(yandex_pass)
            ...
            for tourism_type, tourism_title in settings.TOURISM_TYPES:
                ...
                self.stdout.write(self.style.WARNING("Refreshing of " + tourism_type))
